...
export const routes: Routes = [
...

    {
        ...
        loadComponent: () => import('./shared/components/smart/settings/settings.component').then(m => m.SettingsComponent)
    },
    {
        path: 'my-adverts',
        canActivate: [authGuard],
        loadComponent: () => import('./shared/components/smart/my-adverts/my-adverts.component').then(m => m.MyAdvertsComponent)
    }
];
